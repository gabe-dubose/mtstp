...
write.csv(phylo.data, '/home/gabe/Desktop/mtstp/data/intermediate_data/gene_cluster_diversity_analysis/gene_family_diversity_vs_expression_diversity_global_data.csv', row.names=FALSE)
...
#11
n11 <- phylo.data[phylo.data$n.genes == 11, ]
cor.test(x=as.numeric(n11$gene.cluster.phylogenetic.diversity), y=as.numeric(n11$standardized.expression.pattern.diversity), method="spearman", alternative="g")

#13
n13 <- phylo.data[phylo.data$n.genes == 13, ]
cor.test(x=as.numeric(n13$gene.cluster.phylogenetic.diversity), y=as.numeric(n13$standardized.expression.pattern.diversity), method="spearman", alternative="g")
